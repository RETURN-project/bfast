...
#' # the standard typology, and as interrupted increase, accelerating after the breakpoint,
...
#' bfast01classify(bf1, typology = "drylands") # Interrupted increase, Accelerating
#' 
...
#' # standard typology, and as a complete posiive reverlsa by the typology optimized
#' # for drylands.
#' 
...
#' bfast01classify(bf2, typology = "drylands") # Positive reversal, Complete
#' 
#' # Visualizing the time series with break and fitted trends
#' plot(bf2) 
#'
